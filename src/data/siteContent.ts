...
export const siteContent = {
  ...
  ooPoses,
  navItems: [
    { id: "inicio", href: "#inicio", label: "Inicio / 首页" },
    { id: "memories", href: "#memories", label: "Recuerdos / 回忆" },
    { id: "works", href: "#works", label: "IA / AI 小宇宙" },
    { id: "about", href: "#about", label: "Sobre oo / 关于 oo" },
  ] satisfies NavItem[],
  hero: {
    title: "Hola, soy oo",
  ...
  memoryCards: [
    ...
    },
    {
      ...
      type: "image",
      title: "杭州的日常",
      subtitleEs: "Hangzhou · vida diaria",
    ...
    },
    {
      ...
      type: "video",
      title: "可爱的水果星球",
      subtitleEs: "Planeta fruta · video",
    ...
    },
    {
      ...
      type: "image",
      title: "努力工作的 oo",
      subtitleEs: "Trabajo · ideas claras",
    ...
    },
    {
      ...
      type: "image",
      title: "周末的小快乐",
      subtitleEs: "Finde · pequeñas alegrías",
    ...
    },
    {
      ...
      type: "image",
      title: "咖啡和冬天",
      subtitleEs: "Café · invierno dulce",
      description: "一杯热咖啡、一点暖灯和柔软外套，把冷天也变成可以收藏的小片段。",
      quoteEs: "Un café caliente para un día suave.",
      dateLabel: "Winter · Café",
      tags: ["Café", "Invierno", "Dulce vida"],
      sticker: "☕",
...
- 支持满意度反馈闭环`,
  ...
  footerContent: {
    poseId: "avocado" as keyof typeof ooPoses,
